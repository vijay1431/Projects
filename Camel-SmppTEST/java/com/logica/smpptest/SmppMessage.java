 ...
 */
public class SmppMessage extends org.apache.camel.impl.DefaultMessage {
    ...
    protected Object createBody() {
        if (command instanceof MessageRequest) {
            ...
            String encoding = ExchangeHelper.getContentType(getExchange());
